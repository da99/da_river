...
Job.prototype.finish = function (rep, err) {
  ...
  if (me.is_fin || me.has_error())
    throw new Error('Job already finished: ' + me.group + ' ' + me.id);
  if (parent(me).is_finished()) {
    throw new Error('Ancestor already finished: ' + parent(me).group + ' ' + parent(me).id);
  }
